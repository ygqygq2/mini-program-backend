 ...
 */
class Auth {
  _getUser(openid: any, accessToken: any) {
    throw new Error("Method not implemented.");
  }
  appid: string;
  appsecret: string;
  store: any;
  getAuthorizeURL!: (redirect_uri: any, scope: any, state: any) => Promise<unknown>;
  processToken!: (data: {create_at: number; openid: any;}) => any;
  getAccessToken!: (code: any) => Promise<unknown>;
  refreshAccessToken!: (refreshToken: any) => Promise<unknown>;
  getUser!: (openid: any) => Promise<any>;
  getUserByCode!: (code: any) => Promise<any>;
  ...
  getToken (openid: string | number) {
    return this.store[openid];
  }

  saveToken (openid: string | number, token: any) {
 ...
 */
Auth.prototype.getAuthorizeURL = function (redirect_uri: any, scope: any, state: any) {
 ...
 * 处理token，更新过期时间
 */
Auth.prototype.processToken = function (data: { create_at: number; openid: any }) {
 ...
 */
Auth.prototype.getAccessToken = function (code: any) {
  return new Promise((resolve, reject) => {
 ...
 */
Auth.prototype.refreshAccessToken = function (refreshToken: any) {
  return new Promise((resolve, reject) => {
 ...
 */
Auth.prototype.getUser = async function (openid: any) {
...
Auth.prototype._getUser = function (openid: any, accessToken: any, lang: any) {
  return new Promise((resolve, reject) => {
 ...
 * @param {String} code 授权获取到的code
 */
Auth.prototype.getUserByCode = async function (code: any) {
